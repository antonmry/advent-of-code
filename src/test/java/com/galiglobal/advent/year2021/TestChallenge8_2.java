...
class TestChallenge8_2 {

    @Test
    void testExample() {
        assertEquals(5353, Challenge8_2.sumOutputValues(example));
    }

    @Test
    void testExample2() {
        assertEquals(61229, Challenge8_2.sumOutputValues(example2));
    }

    @Test
    void testChallenge() {
        assertEquals(1020159, Challenge8_2.sumOutputValues(challenge));
    }
