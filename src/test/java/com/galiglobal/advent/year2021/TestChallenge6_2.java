...
class TestChallenge6_2 {
    ...
    void testExample() {
        ...
        //assertEquals(-1, Challenge6_2.countFish(example, 256));
    }

    @Test
    void testChallenge() {
        assertEquals(5934, Challenge6_2.countFish(challenge, 80));
        //assertEquals(5934, Challenge6_2.countFish(challenge, 256));
    }
